...
class cbsSEAccess extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'vtiger_cbsseaccess';
	var $table_index= 'cbsseaccessid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_cbsseaccesscf', 'cbsseaccessid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_cbsseaccess', 'vtiger_cbsseaccesscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_cbsseaccess'   => 'cbsseaccessid',
	    'vtiger_cbsseaccesscf' => 'cbsseaccessid');
	...
	function vtlib_handler($modulename, $event_type) {
		if($event_type == 'module.postinstall') {
			...
			if ($modCmps) $modCmps->setRelatedList($module, 'cbsSEAccess', Array('ADD'),'get_dependents_list');
			// TODO Handle post installation actions
			$this->setModuleSeqNumber('configure', $modulename, 'cbsSE-', '0000001');
